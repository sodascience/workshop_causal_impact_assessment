...
In this practical, you have used growth curves and time-series models to predict the counterfactual: what would the cigarette sales have been in absence of the policy intervention? There are many more details you could go into with these methods, e.g., better specific models, but this provides a starting point.
